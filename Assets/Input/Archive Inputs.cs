...
//     version 1.11.2
//     from Assets/Memories/Input/Archive Inputs.inputactions
//
...
namespace Memories.Input
{
    public partial class @ArchiveInputs: IInputActionCollection2, IDisposable
    {
    ...
    ""controlSchemes"": [
        ...
        ~@ArchiveInputs()
        {
            UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, ArchiveInputs.Player.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, ArchiveInputs.UI.Disable() has not been called.");
        }
        ...
        {
            private @ArchiveInputs m_Wrapper;
            public PlayerActions(@ArchiveInputs wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @ArchiveInputs m_Wrapper;
            public UIActions(@ArchiveInputs wrapper) { m_Wrapper = wrapper; }
