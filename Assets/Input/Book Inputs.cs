...
//     version 1.11.2
//     from Assets/Memories/Input/Book Inputs.inputactions
//
...
{
    public partial class @BookInputs: IInputActionCollection2, IDisposable
    {
    ...
    ""controlSchemes"": [
        ...
        ~@BookInputs()
        {
            UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, BookInputs.Player.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, BookInputs.UI.Disable() has not been called.");
        }
        ...
        {
            private @BookInputs m_Wrapper;
            public PlayerActions(@BookInputs wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @BookInputs m_Wrapper;
            public UIActions(@BookInputs wrapper) { m_Wrapper = wrapper; }
