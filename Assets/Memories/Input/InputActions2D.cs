...
//     version 1.11.2
//     from Assets/Memories/Input/InputActions2D.inputactions
//
...
namespace Memories.Input
{
    ...
    ""controlSchemes"": [
        ...
        ~@InputActions2D()
        {
            UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputActions2D.Player.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputActions2D.UI.Disable() has not been called.");
        }
        ...
        {
            private @InputActions2D m_Wrapper;
            public UIActions(@InputActions2D wrapper) { m_Wrapper = wrapper; }
